...
## Rules
1.  **Static Analysis**: Whenever making changes, be sure to run `dart analyze` and fix all errors, warnings, and lints. This includes resolving all "info" analysis checks, such as line length lints. Never commit code with unresolved analysis issues.
